...
<body>
    <main class="container form-signin  w-100">
        <div class="row">
            <form action="signup.inc.php" method="post" class="col">
            ...
            <form action="/userupdate.inc.php" method="post" class="col">
        ...
        <div class="row">
            <form action="/userdelete.inc.php" method="post" class="col">
            ...
            <form action="/login.inc.php" method="post" class="col">
